...
<div class="row">
	<h2 class="page-header">
    	<a style="float:right" href="add_news.php" class="btn btn-social btn-bitbucket btn-success"><i class="fa fa-plus-circle fa-fw"></i>Add new</a>
    	News Articles
    </h2>
</div>
...
<div class="col-lg-12">
    <div class="panel panel-primary">
        <div class="panel-heading">
        	<i class="fa fa-file-o fa-fw"></i> Articles </div>	
            ...
            <tbody>
                <tr class="odd">
                    ...
                    <td class="right">
                        ...
                        <a href="add_news.php?id={id}" class="edit"><i class="fa fa-edit"></i></a>
                    </td>
                </tr>
            </tbody>
        </table>
