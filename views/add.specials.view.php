...
<div class="row">
	<h2 class="page-header">
    	<a style="float:right" href="specials.php" class="btn btn-social btn-bitbucket btn-success"><i class="fa fa-list fa-fw"></i> List Specials</a>
    	Specials
    </h2>
</div>
...
<div class="row">
    <div class="col-lg-7">
        <div class="panel panel-primary">
            <div class="panel-heading"><i class="fa fa-money fa-fw"></i> <span id="panel-heading">Add</span> </div>	
