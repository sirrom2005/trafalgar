...
<div class="row">
	<h2 class="page-header">
    	<a style="float:right" href="add_specials.php" class="btn btn-social btn-bitbucket btn-success"><i class="fa fa-plus-circle fa-fw"></i>Add Specials</a>
    	Specials
    </h2>
</div>
...
<div class="col-lg-12">
    <div class="panel panel-primary">
        <div class="panel-heading">
        	<i class="fa fa-money fa-fw"></i> Specials</div>	
            ...
            <tbody>
                <tr class="odd">
                    ...
                    <td class="right">
                        ...
                        <a href="add_specials.php?id={id}" class="edit"><i class="fa fa-edit"></i></a>
                    </td>
                </tr>
            </tbody>
        </table>
